    ...
    <div className='custom-modal'>
        <div className='modal-inner'>
            <div className='modal-header'>
                ...
                <h3>Number of cooling degree days</h3>
                <div className='close'>
            ...
            <div className='modal-body'>
                <p>The concept of "cooling degree days" (CDD) is a measure used to assess and quantify the demand for cooling in a particular location during a specified period, typically a day, month, or year. It helps in evaluating the energy requirements for air conditioning or cooling systems in buildings.</p>
                <p>The concept of "cooling degree days" (CDD) is a measure used to assess and quantify the demand for cooling in a particular location during a specified period, typically a day, month, or year. It helps in evaluating the energy requirements for air conditioning or cooling systems in buildings.</p>
                <p>The concept of "cooling degree days" (CDD) is a measure used to assess and quantify the demand for cooling in a particular location during a specified period, typically a day, month, or year. It helps in evaluating the energy requirements for air conditioning or cooling systems in buildings.</p>
                <p>The concept of "cooling degree days" (CDD) is a measure used to assess and quantify the demand for cooling in a particular location during a specified period, typically a day, month, or year. It helps in evaluating the energy requirements for air conditioning or cooling systems in buildings.</p>
            </div>
