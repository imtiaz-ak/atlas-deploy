...
export default function Map() {
  ...
  const ref = useD3(
    (svg) => {
      ...
      let legend = d3.select("#legend-svg").append("g")
        .attr("id", "legend")
      ...
      legendGradient.append("stop")
        .attr("offset", "0%")
        .attr("stop-color", colorScale(variableDomain[selectedVariable][0]));
      legendGradient.append("stop")
        .attr("offset", "50%")
        .attr("stop-color", colorScale((variableDomain[selectedVariable][0] + variableDomain[selectedVariable][1]) / 2));
      legendGradient.append("stop")
        .attr("offset", "100%")
        .attr("stop-color", colorScale(variableDomain[selectedVariable][1]));
